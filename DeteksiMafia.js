...
}else if (umur <= 40 && umur >= 25 && (tempatTinggal == "New Jersey" || tempatTinggal == "Manhattan" || tempatTinggal == "Nevada")&& tabungan >= 1000000 && tabungan <= 2000000 ){
    console.log(nama + ' kemungkinan adalah seorang anggota mafia dengan pangkat Underboss')
}else if (umur <= 24 && umur >= 18 && (tempatTinggal == "California" || tempatTinggal=="Detroit" || tempatTinggal == "Boston")&& tabungan < 1000000 ){
